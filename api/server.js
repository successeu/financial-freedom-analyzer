...
function calculateHealthScore(data) {
    ...
    // Metric 1: Surplus Capacity (0-25 pts)
    ...
    // Metric 2: Financial Cushion (0-25 pts)
    ...
    // Metric 3: Debt-to-Income Ratio (0-25 pts)
    ...
    // Metric 4: Income Diversification (0-15 pts)
    ...
    // Metric 5: Goal Alignment (0-10 pts)
...
function generatePremiumBlueprintHTML(data) {
    ...
    // Determine messaging based on position
    ...
    if (positionType === 'positive') {
        ...
        executiveSummary = `${firstName}, your position requires immediate strategic action. This is a clarity moment. This Blueprint maps your path from financial pressure to surplus in 30-90 days.`;
        if (healthScore < 45) {
    ...
    <body>
        ...
        <div class="page">
            ...
            <div class="footer">
                ...
                <p style="margin-top: 10px;">Ready to accelerate? Book your strategy session: calendly.com/june-yoon/your-90-day-wealth-blueprint</p>
            </div>
        </div>
    </body>
    </html>
